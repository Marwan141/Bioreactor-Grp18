...
// int pwmValue = 255; // PWM value for stirring speed control




// int get_RPM_from_sensor() {

//   int sensorValue = analogRead(A0);

//   if (sensorValue > stirring_high_threshold && stirring_start_time == 0) {
//     stirring_start_time = micros();
//   }

//   if (sensorValue < stirring_low_threshold && stirring_start_time != 0) {
...
//     // Adjust PWM value based on stirring speed or any other condition
//     // Example: reduce PWM if stirring speed is too high
...
//   Serial.begin(9600);
//   pinMode(9, OUTPUT);
//   analogWrite(9, pwmValue); // Set initial PWM value
// }
...
//   stirring_RPM = get_RPM_from_sensor();
//   to_send = "R ";
